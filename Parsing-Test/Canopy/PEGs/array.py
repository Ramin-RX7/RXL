# This file was generated from pegs\array.peg
                                                ...
                                                if address11 is not FAILURE:
                                                    ...
                                                    if address12 is not FAILURE:
                                                        ...
                                                        while True:
                                                            ...
                                                            if chunk5 is not None and Grammar.REGEX_1.search(chunk5):
            ...
            if address3 is not FAILURE:
                ...
                if address4 is not FAILURE:
                    ...
                    if elements2 is None:
                        ...
                        address5 = TreeNode4(self._input[index6:self._offset], index6, elements2)
                        self._offset = self._offset
